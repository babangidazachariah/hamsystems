...
mysql://b35bfc72e5de73:d0de149c@us-cdbr-east-06.cleardb.net/heroku_b1434386a052247?reconnect=true
    $con = mysqli_connect("heroku_b1434386a052247","b35bfc72e5de73","d0de149c" ); //or die ('Unable to connect. Check your connection parameters or '.mysql_error($db));
    $sql= "CREATE DATABASE IF NOT EXISTS HyamdaDatabase";
    mysqli_query($sql, $con); // or die(mysql_error($con));
    //make sure our recently created database is the active one
    mysqli_select_db('HyamdaDatabase', $db); //or die(mysql_error($db));
